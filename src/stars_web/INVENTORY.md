...
| game_state.py | High-level loader: assembles GameState from .xy/.m#/.hst files. Parses planet blocks (type 13/14), fleet blocks (type 16/17), design blocks (type 26), production queues (type 28), waypoints (type 20), player/race (type 6), game settings (type 7) |
